...
# output QuantData
write.csv(quantData,file="SpikeIn_QuantData.csv")
...
modelBasedQCPlots(data=resultMultiComparisons$ModelQC,type="ResidualPlots",address="SpikeIn_")

modelBasedQCPlots(data=resultMultiComparisons$ModelQC,type="QQPlots",address="SpikeIn_")
...
result.sample<-designSampleSize(data=quantData,numSample=TRUE,numPep=2,numTran=3,desiredFC=c(1.2,1.5),FDR=0.05,power=0.8)
result.sample
